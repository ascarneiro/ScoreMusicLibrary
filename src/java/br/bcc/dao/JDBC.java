...
public class JDBC {
    ...
    private JDBC(String n)
        ...
        JDBC.conn = DriverManager.getConnection(n.startsWith("jdbc:mysql:") ? n : "jdbc:mysql://localhost:8089/".concat(n));
    }
    ...
    private JDBC(String n, String u, String p)
            throws Exception {
        Class.forName("com.mysql.jdbc.Driver");
        JDBC.conn = DriverManager.getConnection(n.startsWith("jdbc:mysql:") ? n : "jdbc:mysql://localhost:8089/".concat(n), u, p);
    }
